...
flowchart TB
    subgraph L1["🔍 Discovery Layer"]
        A1[MOD-01<br>Universal Ingestion] --> A2[MOD-02<br>Static Deep Analysis]
        A1 --> A3[MOD-03<br>Dynamic Analysis]
    end

    subgraph L2["🧠 Reasoning Layer"]
        A2 --> B1[MOD-04<br>AI Reasoning Core]
        A3 --> B1
    ...
    subgraph L3["🧬 Ecological Layer (EDEN)"]
        C1[Live Feeds<br>WHO AFRO, Africa CDC] --> C2[Lab Ingestion Engine]
        C2 --> C3[BTU Risk Scoring]
        C3 --> C4[Geospatial Dashboard]
        C2 --> C5[NDVI + Acoustic Sensors]
        C5 --> C6[BioImpact Tokens]
    end

    subgraph L4["⚖️ Governance Layer"]
        D1[COVENANT Engine<br>Constitutional CI/CD Guard]
        D2[Trinity Consensus<br>2‑node canonical voting]
        D3[Blockchain Ledger<br>108 blocks, integrity verified]
    end
